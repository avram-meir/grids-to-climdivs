...
sub regrid {
	...
	my $error        = system("$wgrib2 -d 1 $template -import_ieee $input -no_header -little_endian -undefine_val -999. $rpn -set_date 19710101 -set_grib_type j -set_scaling -1 0 -grib_out $grib_orig_fn > /dev/null");
